...
{
    return Order(id, symbol, OrderType::MARKET, side, 0, 0, quantity, OrderTimeInForce::IOC, ORDER_INT_MAX, slippage, 0, 0);
}

inline Order Order::BuyMarket(uint64_t id, uint32_t symbol, uint64_t quantity, uint64_t slippage) noexcept
{
    return Order(id, symbol, OrderType::MARKET, OrderSide::BUY, 0, 0, quantity, OrderTimeInForce::IOC, ORDER_INT_MAX, slippage, 0, 0);
}

inline Order Order::SellMarket(uint64_t id, uint32_t symbol, uint64_t quantity, uint64_t slippage) noexcept
{
    return Order(id, symbol, OrderType::MARKET, OrderSide::SELL, 0, 0, quantity, OrderTimeInForce::IOC, ORDER_INT_MAX, slippage, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::LIMIT, side, price, 0, quantity, tif, max_visible_quantity, ORDER_INT_MAX, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::LIMIT, OrderSide::BUY, price, 0, quantity, tif, max_visible_quantity, ORDER_INT_MAX, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::LIMIT, OrderSide::SELL, price, 0, quantity, tif, max_visible_quantity, ORDER_INT_MAX, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::STOP, side, 0, stop_price, quantity, tif, ORDER_INT_MAX, slippage, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::STOP, OrderSide::BUY, 0, stop_price, quantity, tif, ORDER_INT_MAX, slippage, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::STOP, OrderSide::SELL, 0, stop_price, quantity, tif, ORDER_INT_MAX, slippage, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::STOP_LIMIT, side, price, stop_price, quantity, tif, max_visible_quantity, ORDER_INT_MAX, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::STOP_LIMIT, OrderSide::BUY, price, stop_price, quantity, tif, max_visible_quantity, ORDER_INT_MAX, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::STOP_LIMIT, OrderSide::SELL, price, stop_price, quantity, tif, max_visible_quantity, ORDER_INT_MAX, 0, 0);
}
...
{
    return Order(id, symbol, OrderType::TRAILING_STOP, side, 0, stop_price, quantity, tif, ORDER_INT_MAX, slippage, trailing_distance, trailing_step);
}
...
{
    return Order(id, symbol, OrderType::TRAILING_STOP, OrderSide::BUY, 0, stop_price, quantity, tif, ORDER_INT_MAX, slippage, trailing_distance, trailing_step);
}
...
{
    return Order(id, symbol, OrderType::TRAILING_STOP, OrderSide::SELL, 0, stop_price, quantity, tif, ORDER_INT_MAX, slippage, trailing_distance, trailing_step);
}
...
{
    return Order(id, symbol, OrderType::TRAILING_STOP_LIMIT, side, price, stop_price, quantity, tif, max_visible_quantity, ORDER_INT_MAX, trailing_distance, trailing_step);
}
...
{
    return Order(id, symbol, OrderType::TRAILING_STOP_LIMIT, OrderSide::BUY, price, stop_price, quantity, tif, max_visible_quantity, ORDER_INT_MAX, trailing_distance, trailing_step);
}
...
{
    return Order(id, symbol, OrderType::TRAILING_STOP_LIMIT, OrderSide::SELL, price, stop_price, quantity, tif, max_visible_quantity, ORDER_INT_MAX, trailing_distance, trailing_step);
}
