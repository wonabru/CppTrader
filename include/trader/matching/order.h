...
*/
    ...
    */
            ...
            Order(uint64_t id, uint32_t symbol, OrderType type, OrderSide side, uint64_t price, uint64_t stop_price, uint64_t quantity,
                  ...
                  uint64_t max_visible_quantity = ORDER_INT_MAX,
                  uint64_t slippage = ORDER_INT_MAX,
            ...
            bool IsIceberg() const noexcept { return MaxVisibleQuantity < ORDER_INT_MAX; }

            //! Is the order have slippage?
            bool IsSlippage() const noexcept { return Slippage < ORDER_INT_MAX; }

            //! Validate order parameters
            ErrorCode Validate() const noexcept;

            //! Prepare a new market order
            static Order Market(uint64_t id, uint32_t symbol, OrderSide side, uint64_t quantity, uint64_t slippage = ORDER_INT_MAX) noexcept;
            //! Prepare a new buy market order
            static Order BuyMarket(uint64_t id, uint32_t symbol, uint64_t quantity, uint64_t slippage = ORDER_INT_MAX) noexcept;
            //! Prepare a new sell market order
            static Order SellMarket(uint64_t id, uint32_t symbol, uint64_t quantity, uint64_t slippage = ORDER_INT_MAX) noexcept;

            //! Prepare a new limit order
            static Order Limit(uint64_t id, uint32_t symbol, OrderSide side, uint64_t price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
            //! Prepare a new buy limit order
            static Order BuyLimit(uint64_t id, uint32_t symbol, uint64_t price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
            //! Prepare a new sell limit order
            static Order SellLimit(uint64_t id, uint32_t symbol, uint64_t price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;

            //! Prepare a new stop order
            static Order Stop(uint64_t id, uint32_t symbol, OrderSide side, uint64_t stop_price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t slippage = ORDER_INT_MAX) noexcept;
            //! Prepare a new buy stop order
            static Order BuyStop(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t slippage = ORDER_INT_MAX) noexcept;
            //! Prepare a new sell stop order
            static Order SellStop(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t slippage = ORDER_INT_MAX) noexcept;

            //! Prepare a new stop-limit order
            static Order StopLimit(uint64_t id, uint32_t symbol, OrderSide side, uint64_t stop_price, uint64_t price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
            //! Prepare a new buy stop-limit order
            static Order BuyStopLimit(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
            //! Prepare a new sell stop-limit order
            static Order SellStopLimit(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t price, uint64_t quantity, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;

            //! Prepare a new trailing stop order
            static Order TrailingStop(uint64_t id, uint32_t symbol, OrderSide side, uint64_t stop_price, uint64_t quantity, int64_t trailing_distance, int64_t trailing_step = 0, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t slippage = ORDER_INT_MAX) noexcept;
            //! Prepare a new trailing buy stop order
            static Order TrailingBuyStop(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t quantity, int64_t trailing_distance, int64_t trailing_step = 0, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t slippage = ORDER_INT_MAX) noexcept;
            //! Prepare a new trailing sell stop order
            static Order TrailingSellStop(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t quantity, int64_t trailing_distance, int64_t trailing_step = 0, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t slippage = ORDER_INT_MAX) noexcept;

            //! Prepare a new trailing stop-limit order
            static Order TrailingStopLimit(uint64_t id, uint32_t symbol, OrderSide side, uint64_t stop_price, uint64_t price, uint64_t quantity, int64_t trailing_distance, int64_t trailing_step = 0, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
            //! Prepare a new trailing buy stop-limit order
            static Order TrailingBuyStopLimit(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t price, uint64_t quantity, int64_t trailing_distance, int64_t trailing_step = 0, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
            //! Prepare a new trailing sell stop-limit order
            static Order TrailingSellStopLimit(uint64_t id, uint32_t symbol, uint64_t stop_price, uint64_t price, uint64_t quantity, int64_t trailing_distance, int64_t trailing_step = 0, OrderTimeInForce tif = OrderTimeInForce::GTC, uint64_t max_visible_quantity = ORDER_INT_MAX) noexcept;
        };
